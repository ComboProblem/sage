...
cdef class PPliteGenerator(object):
	def __init__(self, *args):
		...
		# 	if isinstance(a, Affine_Expression):
		# 		ee = (<Linear_Expression> a.linear_form()).thisptr[0]
		# 		d = a.inhomogeneous_term()
		# 		dd = Python_int_to_FLINT_Integer(d) # this could be written better. 
		# 		self.thisptr = new Gen(tt, ee, dd)
		# 		return
		# 	raise ValueError("Two inputs needs a Generator Type and an Affine_Expression")
		if len(args) == 3:
			t = args[0]
			e = args[1]
			d = args[2]
